...
export declare type RefinementStrategy = typeof STRATEGY_NEVER | typeof STRATEGY_REPLACE | typeof STRATEGY_DEFAULT | RefinementStrategyFunction;
export declare type Tileset2DProps = Pick<Required<TileLayerProps>, 'tileSize' | 'maxCacheSize' | 'maxCacheByteSize' | 'refinementStrategy' | 'extent' | 'maxZoom' | 'minZoom' | 'maxRequests' | 'zoomOffset'> & {
