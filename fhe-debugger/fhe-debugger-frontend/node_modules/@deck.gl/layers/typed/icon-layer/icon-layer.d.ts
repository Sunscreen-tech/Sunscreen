...
import type { LayerProps, LayerDataSource, Accessor, AccessorFunction, Position, Color, Texture, Unit, UpdateParameters, LayerContext, DefaultProps } from '@deck.gl/core/typed';
...
export declare type IconLayerProps<DataT = any> = _IconLayerProps<DataT> & LayerProps;
