...
import type { LayerProps, LayerDataSource, Color, Accessor, AccessorFunction, Unit, UpdateParameters, GetPickingInfoParams, PickingInfo, DefaultProps } from '@deck.gl/core/typed';
...
export declare type PathLayerProps<DataT = any> = _PathLayerProps<DataT> & LayerProps;
