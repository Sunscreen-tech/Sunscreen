...
const ktx2_basis_writer_nodejs_1 = require("../ktx2-basis-writer-nodejs");
(() => {
        ...
        switch (type) {
            case 'process':
                try {
                    ...
                    const result = await ktx2_basis_writer_nodejs_1.KTX2BasisWriterNodeJS.encode(input, options);
