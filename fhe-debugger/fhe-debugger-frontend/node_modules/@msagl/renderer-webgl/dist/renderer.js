...
import { layoutGraph, layoutGraphOnWorker, deepEqual, TextMeasurer } from '@msagl/renderer-common';
import { GeomGraph, Rectangle, GeomNode, TileMap, geometryIsCreated } from '@msagl/core';
import { Matrix4 } from '@math.gl/core';
import EventSource from './event-source';
import GraphHighlighter from './layers/graph-highlighter';
import { getIconAtlas } from './layers/arrows';
import { DefaultGraphStyle } from './styles/graph-style-spec';
import { parseGraphStyle } from './styles/graph-style-evaluator';
const MaxZoom = 2;
/**
...
export default class Renderer extends EventSource {
    constructor(container = document.body, layoutWorkerUrl) {
        super();
        this._layoutOptions = {};
        this._controls = [];
        this._style = parseGraphStyle(DefaultGraphStyle);
     ...
     */
    async setGraph(graph, options = this._layoutOptions) {
    ...
    async _layoutGraph(forceUpdate) {
