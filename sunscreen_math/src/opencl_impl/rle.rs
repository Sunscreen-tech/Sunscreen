use super::{radix_sort::{prefix_sum, PrefixSumType}, Grid, MappedBuffer, Runtime};
...
pub fn run_length_encoding(data: &MappedBuffer<u32>, rows: u32, cols: u32) -> RunLengthEncoding {
    ...
    let scanned_backward_mask = prefix_sum::<u32>(&backward_mask, rows, cols, PrefixSumType::Exclusive);
