...
export declare type Operation = 'draw' | 'mask' | 'terrain';
 ...
 */
export declare type LayerDataSource<DataType> = LayerData<DataType> | string | AsyncIterable<DataType[]> | Promise<LayerData<DataType>>;
/**
...
export declare type CompositeLayerProps = LayerProps & {
