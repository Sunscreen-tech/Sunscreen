import { BinaryAttribute, LayerProps } from '@deck.gl/core/typed';
...
export declare function createLayerPropsFromBinary(geojsonBinary: Required<ExtendedBinaryFeatures>, encodePickingColor: any): SubLayersProps;
export {};
