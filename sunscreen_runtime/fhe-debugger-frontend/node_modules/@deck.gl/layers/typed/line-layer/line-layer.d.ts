import { Layer, LayerProps, LayerDataSource, Unit, Position, Accessor, Color, UpdateParameters, DefaultProps } from '@deck.gl/core/typed';
import { Model } from '@luma.gl/core';
/** All properties supported by LineLayer. */
export declare type LineLayerProps<DataT = any> = _LineLayerProps<DataT> & LayerProps;
