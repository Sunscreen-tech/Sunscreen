...
import type { UpdateParameters, LayerContext, LayerProps, LayerDataSource, Position, Color, Accessor, DefaultProps } from '@deck.gl/core/typed';
export declare type ScenegraphLayerProps<DataT = any> = _ScenegraphLayerProps<DataT> & LayerProps;
