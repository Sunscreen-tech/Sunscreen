...
exports.hashObject = exports.hashSymbol = exports.hashString = exports.hashBigInt = exports.hashNumber = void 0;
const xxhash32_js_1 = require("./hashers/xxhash32.js");
const xxhash64_js_1 = require("./hashers/xxhash64.js");
...
const hashNumber = x => hashNumberCore(x);
exports.hashNumber = hashNumber;
const hashBigInt = x => hashBigIntCore(x);
exports.hashBigInt = hashBigInt;
const hashString = x => hashStringCore(x);
exports.hashString = hashString;
const hashSymbol = x => hashSymbolCore(x);
exports.hashSymbol = hashSymbol;
const hashObject = x => hashObjectCore(x);
