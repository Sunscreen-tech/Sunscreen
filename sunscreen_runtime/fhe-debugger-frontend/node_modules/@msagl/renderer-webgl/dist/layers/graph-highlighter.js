...
export default class GraphHighlighter {
    ...
    delete() {
        var _a, _b, _c, _d;
        (_a = this._edgeSourceBuffer) === null || _a === void 0 ? void 0 : _a.delete();
        (_b = this._edgeTargetBuffer) === null || _b === void 0 ? void 0 : _b.delete();
        (_c = this._edgeDirectionBuffer) === null || _c === void 0 ? void 0 : _c.delete();
        (_d = this._edgeDepthBuffer) === null || _d === void 0 ? void 0 : _d.delete();
    ...
    setGraph(graph) {
        ...
        for (const edge of graph.deepEdges) {
            ...
            const de = DrawingObject.getDrawingObj(edge.edge);
    ...
    update(opts) {
        ...
        let sourceTexture = this._nodeDepthTextures[1];
        let targetTexture = this._nodeDepthTextures[0];
        if (sourceId) {
    ...
    _resetNodeDepth(texture, originPixelIdx) {
        this._nodeDepthFB.attach({
...
function getBuffer(gl, buffer, accessor, instanceCount) {
    if (!buffer) {
...
function encodePickingColor(i, out) {
    out[0] = (i + 1) & 255;
    out[1] = ((i + 1) >> 8) & 255;
    out[2] = (((i + 1) >> 8) >> 8) & 255;
    return out;
}
//# sourceMappingURL=graph-highlighter.js.map